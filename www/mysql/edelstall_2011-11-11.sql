...
# Database: edelstall
# Generation Time: 2011-11-11 16:55:28 +0000
# ************************************************************
...
VALUES
	(1,'admin','7e523a069053bd727bf980a2eaef2913c8692c1e','Admin','Admin','noreply@churchdeploy.com','2011-11-11 08:53:40','developer','yes',NULL,'no',NULL);
...
VALUES
	(39,49,'sante','Sante','sante','Sante',1,'Sante',NULL,NULL,0,NULL);
...
VALUES
	(52,49,'/uploads/projects/screen-shot-2011-11-10-at-4.00-4ebd4c8469e91.png',1089309,'image/png','a:3:{s:8:\"creation\";s:25:\"2011-11-11T16:25:40+00:00\";s:5:\"width\";i:1127;s:6:\"height\";i:1001;}');
...
VALUES
	(39,49,NULL,'New website for the **Sante** product line.',NULL,'New website for the **Sante** product line.',7,'<p>New website for the <strong>Sante</strong> product line.</p>\n',NULL,NULL,0,'\n');
...
VALUES
	(26,49,'http-santede','http://sante.de','http-santede','http://sante.de',1,'http://sante.de',NULL,NULL,0,NULL);
...
INSERT INTO `sym_entries_data_23` (`id`, `entry_id`, `start`, `end`)
VALUES
	(1,49,'2011-11-12 00:45:00','2011-11-12 00:45:00');
...
VALUES
	...
	(23,'Date','date','datetime',2,'no',5,'sidebar','yes');
...
VALUES
	(99,14,25,'single','none',NULL,0,'yes','yes'),
	(100,22,25,'single','none','/^[^\\s:\\/?#]+:(?:\\/{2,3})?[^\\s.\\/?#]+(?:\\.[^\\s.\\/?#]+)*(?:\\/[^\\s?#]*\\??[^\\s?#]*(#[^\\s#]*)?)?$/',0,'yes','yes'),
	(101,17,25,'medium','markdown_extra_with_smartypants',NULL,0,'yes','yes');
...
VALUES
	(42,16,'/workspace/uploads/projects','/\\.(?:bmp|gif|jpe?g|png)$/i');
...
VALUES
	...
	(3,NULL,'Projects','projects',NULL,'pt1/pt2/pt3','members,projects_all_entries_by_date','project_create',3);
...
VALUES
	...
	(2,'Projects','projects',2,NULL,'asc','no','Members');
...
VALUES
	...
	('cc2880a432a920cc89af715884fdee7c',1321030420,'sym-|a:2:{s:8:\"username\";s:5:\"admin\";s:4:\"pass\";s:40:\"7e523a069053bd727bf980a2eaef2913c8692c1e\";}sym-members|a:3:{s:2:\"id\";s:1:\"8\";s:5:\"email\";s:17:\"kirk@strobeck.com\";s:8:\"password\";s:40:\"b5bde009c7ef85f05fa1a3ffc1fa43a545ac3c62\";}');
